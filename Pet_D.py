...
class Pet:
    ...
    def __str__(self):  #this means it already exists but we are overwritting it
...
typicalCat.wantsToSit()  #b/c the cat doesn't return anything it just prints, we don't need a variable.

print(typicalCat)

#print(Dog)      #it just prints the properies of the dog not the info,
